...
export default function Terror() {
    ...
    useEffect(() => {
        const promise = axios.get(`${process.env.REACT_APP_BACKEND_URL}/livros/`, { params: { genero: 'Terror' } })
        ...
        return livrosAventura.map(book => {
            ...
            return (
                <div className='livroTerror'>
                    ...
                    <br></br>
                    <Link to={url}><button className='botaoMaisTerror' >Quero saber mais!</button></Link>
                </div>
            )
        })
    }
